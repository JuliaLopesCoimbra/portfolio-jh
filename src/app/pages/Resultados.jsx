...
export default function AntesDepois() {
  ...
  return (
    <section id="resultados" className="relative bg-black text-neutral-100 py-20 px-6">
      <div
        aria-hidden
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <header className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-semibold text-white">
            Antes e <span className="text-amber-300">Depois</span>
          </h2>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex flex-col items-center">
                        <div className="aspect-[3/4] w-full overflow-hidden rounded-xl border border-neutral-700">
                          <img src={ex.antes} alt={`${ex.nome} antes`} loading="lazy" className="h-full w-full object-cover" />
                        </div>
                        <span className="mt-2 text-xs text-neutral-400 uppercase tracking-wide">Antes</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="aspect-[3/4] w-full overflow-hidden rounded-xl border border-neutral-700">
                          <img src={ex.depois} alt={`${ex.nome} depois`} loading="lazy" className="h-full w-full object-cover" />
                        </div>
                        <span className="mt-2 text-xs text-amber-300 uppercase tracking-wide">Depois</span>
                      </div>
                    </div>
                    {/* <div className="mt-4 text-center">
                      <p className="text-lg font-semibold text-white">{ex.nome}</p>
                      <p className="text-sm text-amber-300">{ex.resultado}</p>
                    </div> */}
                  </div>
                </div>
              ))}
...
>
  {/* seta ESQUERDA */}
  <svg viewBox="0 0 24 24" className="h-5 w-5 text-amber-300" aria-hidden="true">
...
>
  ...
  <svg viewBox="0 0 24 24" className="h-5 w-5 text-amber-300 rotate-180" aria-hidden="true">
    <path fill="currentColor" d="M15.41 7.41 14 6l-6 6 6 6 1.41-1.41L10.83 12z" />
  </svg>
</button>
